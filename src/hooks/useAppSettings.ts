...
export function useAppSettings() {
  ...
  const [includeDirectoryStructure, setIncludeDirectoryStructure] = usePersistentState(
  ...
  const [includeEmptyDirectories, setIncludeEmptyDirectories] = usePersistentState(
    'exportIncludeEmptyDirectories',
    false
  );
