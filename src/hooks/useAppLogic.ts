...
import type { ConfirmationState, FileContent } from '../types';
import { clearPersistedAppData } from '../services/appStorage';
import type { ActiveView, AppLogicReturn, MobileView } from './useAppLogicTypes';
...
export const useAppLogic = (
  ...
  React.useEffect(() => {
    isBusyRef.current = isLoading || isExporting;
  ...
  const [activeView, setActiveView] = React.useState<ActiveView>('structure');
  ...
  const {
    ...
    extractContent,
    maxCharsThreshold,
    useDefaultIgnorePatterns: useDefaultPatterns,
    useGitignorePatterns: useGitignore,
    includePatterns,
    ignorePatterns,
    includeEmptyDirectories,
    setIsLoading,
  ...
  return {
    ...
    handlers: {
      ...
      handleDrop: (e: React.DragEvent) => {
        setIsDragging(false);
        handleDrop(e, isBusyRef.current);
      },
      handleFileSelect,
      handleRecentProjectSelect,
      handleCopyAll,
