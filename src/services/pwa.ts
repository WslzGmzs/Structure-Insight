export function registerAppServiceWorker(navigatorLike: Navigator = navigator, windowLike: Window = window): void {
  ...
  windowLike.addEventListener('load', () => {
    ...
    void navigatorLike.serviceWorker.register(serviceWorkerUrl).catch((error) => {
